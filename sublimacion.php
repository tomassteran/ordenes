...
<div class="modal fade" id="modalForm" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">Solicitud de REPOSICIONES</h4>
            ...
            <div class="modal-body">
                ...
                <form role="form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="Tela" placeholder="Perfil de entonacion"/>
                    </div>
                    <div class="form-group">
                        <label for="Piezas">Piezas</label>
                        <input type="text" class="form-control" id="Piezas" placeholder="Impresora"/>
                    </div>
                    <div class="form-group">
                        <label for="Talla">Talla</label>
                        <input type="text" class="form-control" id="Talla" placeholder="Nota"/>
                    </div>
                    <div class="form-group">
                        <label for="Referencia">Referencia</label>
                        <input type="text" class="form-control" id="Referencia" placeholder="Nota"/>
                    </div>                   
                </form>
            </div>
    ...
    <i class="material-icons align-middle md-36">short_text</i>
                            ...
                            <div class="page-title m-0">Departamento de sublimacion</div>
            ...
            alt="">
                ...
                <div class="mdk-header-layout__content top-navbar mdk-header-layout__content--scrollable h-100">
                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center mb-3">
                            <div class="col-md-6">
                                <h1 class="h2 mb-0">Departamento de sublimacion</h1>
              ...
              <small class="align-middle text-uppercase">Print</small>
                        ...
                        <div class="card">
                            <div class="table-responsive">
                                <table class="table m-0">
                                    ...
                                    <tbody>
                                        <?php
                                        $disenoSQL = "SELECT * FROM `live_records` WHERE designation LIKE 'SUBLIMACION%' AND estado_op = '1'";
                        ...
                        <div class="row">
                            <div class="col-ms-1">
                                <div class="card">
                           <button class="btn btn-success btn-lg" data-toggle="modal" data-target="#modalForm">REPOSICIONES</button>                               
                                </div>
                            </div>                            
                        </div>
                        <h1>Reposiciones</h1>
    ...
    if(orden.trim() == '' ){
        ...
        $.ajax({
            type:'POST',
            url:'visor/addsublimacion.php',
            data:'contactFrmSubmit=1&orden='+orden+'&diseno='+diseno+'&Tela='+Tela+'&Piezas='+Piezas+'&Talla='+Talla+'&Referencia='+Referencia,
            beforeSend: function () {
