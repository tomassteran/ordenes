...
class Records {	
	...
	public function listRecords(){
		...
		$sqlQuery = "SELECT * FROM ".$this->recordsTable." WHERE `estado_op` = '1'";
	...
	public function updateRecord(){
		...
		if($this->id) {	
			...
			$stmt->bind_param("sisisssssi", $this->ordenp, $this->id_user, $this->name, $this->age, $this->skills, $this->address, $this->designation, $this->categoria, $this->modificado, $this->id);
	...
	public function addRecord(){
		...
		if($this->name) {
			...
			$stmt->bind_param("sisissssss", $this->ordenp, $this->id_user, $this->name, $this->age, $this->skills, $this->address, $this->designation, $this->categoria, $this->estado_op, $this->modificado);
	...
	public function deleteRecord(){
		...
		if($this->id) {
			...
			$stmt = $this->conn->prepare("
				UPDATE ".$this->recordsTable." 
			SET id_user = ?, estado_op = ?, modificado = ?
			WHERE id = ?");
			...
			$stmt->bind_param("iiss", $this->id_user, $this->estado_op, $this->modificado, $this->id);
